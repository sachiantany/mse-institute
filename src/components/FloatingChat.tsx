    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      {open && (
        <div className="flex flex-col gap-2.5 mb-1 animate-in">
          ...
          {/* Messenger */}
          <a
            href="https://m.me/MSEHEC"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 bg-[#0084FF] text-white pl-4 pr-5 py-2.5 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all"
          >
            <svg className="w-5 h-5 shrink-0" fill="currentColor" viewBox="0 0 24 24">
      ...
      <button
        ...
        className={`w-14 h-14 rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-300 ${
          open
